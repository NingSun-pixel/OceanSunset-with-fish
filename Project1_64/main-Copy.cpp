...
void loadSingleModel(const std::string& path, Model& model) {
    ...
    //for (int i = 0; i < ConstNameTexOfFBX.size(); i++)
    //{
    //    if (modelName.find(ConstNameTexOfFBX[i]) != std::string::npos)
    //    {
    //        modelName = ConstNameTexOfFBX[i];
    //        cout << "Inside + " + modelName << endl;
    //        isConstTex = true;
    //    }
    //}
    ////if (modelName.find("CoralRock") != std::string::npos)
    ////{
    ////    modelName = "CoralRock";
    ////    cout <<"Inside + " + modelName << endl;
    ////}
    ...
    ////    if(modelName.find("Coral_1") != std::string::npos)
    ////    {
    ////        modelName = "Coral_1";
    ////        cout << "Inside + " + modelName << endl;
    ////    }
    ...
    //}
    ////}
    std::filesystem::path texturePath = modelDirectory + "/Texture/" + modelName + ".png";
...
int main(int argc, char** argv) {
    ...
    // 加载模型并设置 OpenGL 缓冲区
    std::vector<std::string> fbxFiles = getAllFBXFiles("C:/Users/555/Desktop/assignment/CG_Project_1/FBX_1");
    //std::vector<std::string> fbxFiles;
